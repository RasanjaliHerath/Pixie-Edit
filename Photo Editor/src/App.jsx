...
function App() {
  ...
  function handleSaveImage() {
    ...
    img.onload = () => {
      ...
      alert('Image successfully saved and downloaded!');
    };
  }
  ...
  return (
    ...
    <>
<section className="w-full max-w-[850px] flex mx-auto items-center justify-center bg-blue mt-28 min-h-[200px] rounded-lg shadow-lg">
<div className='w-full mx-8 mt-10'>
<h2 className='font-poppins text-xl font-bold mb-8 text-transparent bg-clip-text bg-gradient-to-r from-blue-900 via-blue-950 to-indigo-900'>
  Pixie Edit
</h2>
